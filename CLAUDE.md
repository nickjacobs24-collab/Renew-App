...
**STATUS: Three colour registers locked — gradient-dark (P1/P3/P5), JET BLACK flat #000 (P4 only, the standout), cream (P2/P6/P7). P4 rebuilt as the jet-black robin-hood-2 panel (dark soft-glow card, straight centred phone, sparing green). P7 flipped black→cream so P4's jet black is unique. Phones straight (not tilted). Cream lightened to #FAF8F3. Full page on `rebuild`. Outstanding before ship: all visuals, OG image, FAQ answers, Privacy/Terms, disclaimer, integration list, launch swap. Do not re-run completed phases.**
...
- **Colour registers (visuals round — supersedes the two-colour map): THREE registers, not rigid alternation.** (1) **Gradient-dark** — the brand black→`#0A3C0A` fade (P1, P3, P5). (2) **Jet black** — flat `#000000`, **P4 ONLY** (the standout: flatter and blacker than its neighbours so the phone pops, robin hood 2). (3) **Cream** — near-off-white `#F7F2E8`→`#FAF8F3` (P2, P6, P7). Green `#3AB203` stays a sparing accent, never a background. Because P4's flat black is unique, band order no longer needs strict alternation — P4 stands out anywhere. Register map: P1 gradient-dark · P2 cream · P3 gradient-dark · P4 **jet black** · P5 gradient-dark · P6 cream · P7 cream (flipped from flat black so P4's jet black stays unique).
...
- **P7 FAQ + Footer** — no imagery. Cream register (flipped from flat black so P4's jet black stays unique).
...
- Cream (light register): near-off-white **`#FAF8F3`** with ink **`#14140F`** — lightened from `#F7F2E8`, which read too deep/yellow; faint warmth only. Jet-black register (P4 only) is flat `#000000` — warmth sampled from the reference class and the cream CTA pills in the App Store screens. Founder judges the exact temperature on preview.
