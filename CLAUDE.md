...
**STATUS: P3/P5 lean richer green (frame P4 green→jet-black→green); P4 stays flat jet-black standout. P7 restored to flat black (the cream flip was wrong). P6 now centred (robin hood 3), header two lines, slim field+button, three images removed. Cream lightened to near-white #FCFBF8. Phones straight. Full page on `rebuild`. Outstanding before ship: all visuals, OG image, FAQ answers, Privacy/Terms, disclaimer, integration list, launch swap. Do not re-run completed phases.**
