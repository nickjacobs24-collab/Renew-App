...
const goals = [
  { id: 'energy', name: 'Improve energy and focus', icon: Zap, baseColor: '#F97316', lightColor: '#FB923C', darkColor: '#EA580C', iconBg: 'bg-orange-100' },
  ...
  { id: 'gutHealth', name: 'Better digestion and gut health', icon: Smile, baseColor: '#F59E0B', lightColor: '#FBBF24', darkColor: '#D97706', iconBg: 'bg-amber-100' },
