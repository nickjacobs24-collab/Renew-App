...
<p className={`text-white/80 font-normal mt-4 mx-auto transition-all duration-1000 delay-[700ms] ${
  ...
  Create a free account to view your personalised results.
          ...
          <div className="max-w-md mx-auto">
            {/* Clerk Sign Up Component - Slightly bigger since dev mode will disappear */}
            <div className={`transition-all duration-1000 delay-[800ms] ${
              ...
              <SignUp
                routing="hash"
                signInUrl="/sign-in"
                afterSignUpUrl={`/results?${searchParams.toString()}`}
                appearance={{
                  elements: {
                    rootBox: "w-full mx-auto",
                    card: "bg-white shadow-xl rounded-xl px-5 py-2.5",
                    headerTitle: "hidden",
                    headerSubtitle: "hidden",
                    socialButtonsBlockButton: "bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 shadow-sm py-1.5 px-3 text-sm mb-2",
                    ...
                    formFieldInput: "w-full px-3 py-1.5 border-2 border-gray-200 rounded-md focus:border-blue-500 text-sm mb-1.5",
                  ...
                  variables: {
                    spacingUnit: '0.625rem',
                  },
                }}
              />
            </div>

            {/* Skip Link - Right after Clerk box */}
