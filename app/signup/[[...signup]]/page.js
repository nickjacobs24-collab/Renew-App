              ...
              <SignUp
                ...
                appearance={{
                  elements: {
                    ...
                    card: "bg-white shadow-xl rounded-xl px-4 py-2",
                    headerTitle: "hidden",
                    ...
                    formButtonPrimary: "w-full bg-gray-900 text-white hover:bg-gray-800 font-semibold py-1.5 text-xs rounded-lg shadow-lg mt-1.5",
