        ...
        >
          ...
          <p className="text-3xl md:text-4xl font-bold leading-snug text-center max-w-3xl mx-auto" style={{ marginBottom: '14px' }}>
            <span className="bg-gradient-to-r from-blue-900 via-blue-700 to-sky-500 bg-clip-text text-transparent">
              Helps your mind wind down at bedtime
            </span>
          </p>

          <div className="max-w-2xl mx-auto text-left md:text-center text-lg md:text-xl" style={{ maxWidth: '820px', lineHeight: '1.7', marginBottom: '36px' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6" style={{ marginBottom: '30px' }}>
            <div className="rounded-xl p-4" style={{ backgroundColor: '#FAFAFA' }}>
              ...
              <ul className="text-sm space-y-1.5" style={{ fontWeight: 400, color: '#4B5563' }}>
                <li>• Calms racing thoughts at night</li>
                <li>• Supports easier sleep onset</li>
                <li>• Improves sleep quality without sedation</li>
              </ul>
            </div>
            ...
            <div className="rounded-xl p-4" style={{ backgroundColor: '#FAFAFA' }}>
              ...
              <ul className="text-sm space-y-1.5" style={{ fontWeight: 400, color: '#4B5563' }}>
                <li>• Calming effect within 30–60 minutes</li>
                <li>• Sleep benefits within days to weeks</li>
              </ul>
            </div>
...
<div className="rounded-xl p-4 relative" style={{ backgroundColor: '#FAFAFA' }}>
  ...
  <p className="text-[15px] leading-relaxed text-left md:text-center" style={{ fontWeight: 400, color: '#4B5563' }}>
                ...
                Naturally found in green tea — enjoyed safely for centuries and taken daily by millions worldwide.
          ...
          <div>
            <div className="rounded-xl px-6 py-4" style={{ backgroundColor: '#FAFAFA' }}>
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                <a href="https://uk.iherb.com/c/l-theanine" target="_blank" rel="noreferrer" className="transition-transform hover:scale-105">
                  <img src="/images/iherbpill.png" alt="iHerb" width="80" height="50" />
                </a>
                <a href="https://www.amazon.co.uk/s?k=amazon+l+theanine" target="_blank" rel="noreferrer" className="transition-transform hover:scale-105">
