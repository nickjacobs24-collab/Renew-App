...
export default function CalmGlycine({ onClose }) {
...
<p className="text-xs font-semibold tracking-wider uppercase text-left md:text-center pt-12" style={{ color: '#000000', marginBottom: '6px' }}>
  CALM ESSENTIALS
</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6" style={{ marginBottom: '30px' }}>
            <div className="rounded-xl p-4" style={{ backgroundColor: '#FAFAFA' }}>
              ...
              <ul className="text-sm space-y-1.5" style={{ fontWeight: 400, color: '#4B5563' }}>
                <li>• Promotes a calmer state of mind</li>
                <li>• Reduces stress-related tension</li>
                <li>• Supports steady mood</li>
              </ul>
            </div>
            ...
            <div className="rounded-xl px-6 py-3 relative" style={{ backgroundColor: '#FAFAFA' }}>
              <p className="text-[15px] leading-relaxed text-center" style={{ fontWeight: 400, color: '#4B5563' }}>
                ...
                <span className="inline-block group" style={{ marginLeft: '8px', top: '-6px', position: 'relative' }}>
                  ...
                  >
                    Glycine is naturally produced by your body every day and has been safely used as a supplement for decades (U.S. FDA, 2023).
                  </span>
                </span>
              </p>
            </div>
          ...
          <div>
            <div className="rounded-xl px-6 py-4" style={{ backgroundColor: '#FAFAFA' }}>
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                <a href="https://uk.iherb.com/c/glycine" target="_blank" rel="noreferrer" className="transition-transform hover:scale-105">
                  <img src="/images/iherbpill.png" alt="iHerb" width="80" height="50" />
                </a>
                <a href="https://www.amazon.co.uk/s?k=glycine" target="_blank" rel="noreferrer" className="transition-transform hover:scale-105">
