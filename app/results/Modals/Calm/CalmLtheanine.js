...
export default function CalmLTheanine({ onClose }) {
        ...
        >
          ...
          <p className="text-3xl md:text-4xl font-bold leading-snug text-center max-w-3xl mx-auto" style={{ marginBottom: '20px' }}>
            <span className="bg-gradient-to-r from-green-700 via-emerald-600 to-green-500 bg-clip-text text-transparent">
              Keeps you calm without making you drowsy
            </span>
          </p>
          ...
          <div className="mx-auto text-center text-lg md:text-xl" style={{ maxWidth: '860px', lineHeight: '1.7', marginBottom: '36px' }}>
            ...
            <span style={{ fontWeight: 400, color: '#4B5563' }}>
              L-Theanine helps you feel calmer without making you sleepy, so you stay calm and clear-headed.
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6" style={{ marginBottom: '30px' }}>
            <div className="rounded-xl p-4" style={{ backgroundColor: '#FAFAFA' }}>
              ...
              <ul className="text-sm space-y-1.5" style={{ fontWeight: 400, color: '#4B5563' }}>
                <li>• Calms without sedation</li>
                <li>• Helps reduce tension</li>
                <li>• Keeps you alert while calm</li>
              </ul>
            </div>
            ...
            <div className="rounded-xl p-4" style={{ backgroundColor: '#FAFAFA' }}>
              ...
              <ul className="text-sm space-y-1.5" style={{ fontWeight: 400, color: '#4B5563' }}>
                <li>• Calming effect in 30–60 minutes</li>
                <li>• Consistent results with daily use</li>
              </ul>
            </div>
