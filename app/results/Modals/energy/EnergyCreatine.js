      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        >
          ...
          <p className="mt-3 text-lg md:text-xl text-gray-700 text-center leading-relaxed max-w-2xl mx-auto">
            Your body makes some creatine, but not enough for full support. Without it, energy dips can leave you tired.
          </p>
          <p className="mt-3 text-lg md:text-xl text-gray-700 text-center leading-relaxed max-w-2xl mx-auto">
            Topping up recharges your supply so you can keep steady energy all day.
          </p>
          <br />
